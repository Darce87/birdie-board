(() => {
  ...
  style.textContent = `#bb .hole-progress-label{margin:15px 0 8px;color:#cde3db;font:500 10px DM Mono;letter-spacing:1px;text-transform:uppercase}#bb .hole-progress{display:grid;grid-template-columns:repeat(9,1fr);gap:6px}#bb .hole-progress button{height:34px;border:1px solid #3b9378;border-radius:7px;background:#006747;color:#fff;font:600 12px DM Mono;cursor:pointer}#bb .hole-progress button.current{background:#FCE300;border-color:#FCE300;color:#006747}#bb .hole-progress button.done{background:#005238;color:#8ab9aa;text-decoration:line-through}#bb .hole-progress button.done.current{background:#FCE300;color:#006747;text-decoration:none}#bb .score input{font-size:16px!important}@media(max-width:390px){#bb .hole-progress{grid-template-columns:repeat(6,1fr)}}`;
